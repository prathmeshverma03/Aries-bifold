      ...
      <ScrollView style={{ padding: 20 }}>
        ...
        <View style={{ marginBottom: 20 }}>
          ...
          <Text style={[styles.bodyText, { marginTop: 25 }]} testID={testIdWithKey('BodyText')}>
            Information is stored securely, only on this device.{"\n"}
            All information is sent or received over a private, encrypted connection.
          </Text>
        </View>
      </ScrollView>
...
const guides: Array<{ image: React.FC<SvgProps>; title: string; body: string }> = [
  {
    ...
    title: 'Securely store, receive and use digital credentials',
    body: 'You can store digital versions of things like identities, licenses, certificates and permits.',
  },
  {
    image: ScanShare,
    title: 'Easily receive and use credentials.',
    body: 'Use SCAN feature in the application to receive and share information.',
  },
]
